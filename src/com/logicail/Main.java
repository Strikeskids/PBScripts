...
public class Main {
	public static void main(String[] args) throws FileNotFoundException, NoSuchMethodException {
		...
		print(system.clientScriptLoader);
	}

	private static void print(Loader loader) throws FileNotFoundException, NoSuchMethodException {
		PrintWriter writer = null;
		try {
			writer = new PrintWriter("output" + File.separator + loader.getClass().getDeclaredMethod("get", int.class).getReturnType().getSimpleName().toLowerCase() + "-" + loader.version + ".txt");
